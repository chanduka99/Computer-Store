  ...
  return (
    <div className={classes.NavContainer}>
      ...
      <div className={classes.NavItem}>
        <div>
          <Link style={{ fontSize: '24px' }} className={classes.Link} to={unprotectedRoutePaths.SHOP}>
            Shop
          </Link>
          {admin && (
            <>
          ...
          <Link style={{ fontSize: '24px' }} className={classes.Link} to={unprotectedRoutePaths.ABOUT}>
            About us
          </Link>
        </div>
      </div>
